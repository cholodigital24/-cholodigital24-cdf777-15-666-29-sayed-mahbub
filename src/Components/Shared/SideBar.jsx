...
const SocialLinks = [
  {
    ...
    to: "https://www.facebook.com/sayedmahbub008",
  },
  {
    title: "Twitter",
    icons: <FaTwitter className="text-white" />,
    to: "https://twitter.com/imaahhbuub", // Replace with your actual link
  },
  {
    title: "Instagram",
    icons: <FaInstagram className="text-white" />,
    to: "https://www.instagram.com/sayedmaahbub/", // Replace with your actual link
  },
  {
    title: "TikTok",
    icons: <FaTiktok className="text-white" />,
    to: "https://www.tiktok.com/@sayedmahbub", // Replace with your actual link
  },
  {
    title: "YouTube",
    icons: <FaYoutube className="text-white" />,
    to: "https://www.youtube.com/@J4BReaction", // Replace with your actual link
  },
];
